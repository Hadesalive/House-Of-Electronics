...
export const hoeClassicTypeBTemplate: InvoiceTemplate = {
  id: 'hoe-classic-type-b',
  name: 'HOE Classic - Type B',
  description: 'House Of Electronics classic invoice Type B - Compact layout',
  preview: 'hoe-classic-type-b-preview',
  colors: {
...
export const HoeClassicTypeBPreview = () => (
  <div className="w-full h-32 bg-white rounded-lg relative overflow-hidden border border-gray-200">
    ...
    <div className="absolute top-2 left-3 right-3 flex items-start justify-between">
      <div className="flex items-center gap-2">
        ...
        <div className="text-xs font-semibold" style={{ color: '#0f172a' }}>HOE CLASSIC TYPE B</div>
      </div>
