...
export const hoeClassicEkhlasTemplate: InvoiceTemplate = {
  id: 'hoe-classic-ekhlas',
  name: 'HOE Classic',
  description: 'House Of Electronics branding',
...
export const HoeClassicEkhlasPreview = () => (
  <div className="w-full h-32 bg-white rounded-lg relative overflow-hidden border border-gray-200">
    ...
    <div className="absolute top-2 left-3 right-3 flex items-start justify-between">
      <div className="flex items-center gap-2">
        ...
        <div className="text-xs font-semibold" style={{ color: '#0f172a' }}>HOE</div>
      </div>
