    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex gap-2">
            ...
            <Button variant="outline" onClick={() => navigate(`/orders/${orderId}/edit`)}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            >
              <h2 className="text-xs font-semibold mb-3" style={{ color: 'var(--foreground)' }}>
                Financial Summary
              </h2>
            ...
            >
              ...
              <div className="space-y-2 text-sm">
                <div>
                  <p className="text-[11px]" style={{ color: 'var(--muted-foreground)' }}>Created</p>
                ...
                {order.expectedDeliveryDate && (
                  <div>
                    <p className="text-[11px]" style={{ color: 'var(--muted-foreground)' }}>Expected Delivery</p>
                    <p className="font-medium" style={{ color: 'var(--foreground)' }}>
                ...
                {order.actualDeliveryDate && (
                  <div>
                    <p className="text-[11px]" style={{ color: 'var(--muted-foreground)' }}>Actual Delivery</p>
                    <p className="font-medium" style={{ color: 'var(--foreground)' }}>
            ...
            {order.notes && (
              ...
              >
                ...
                <p className="text-sm" style={{ color: 'var(--muted-foreground)' }}>{order.notes}</p>
              </div>
            )}
          </div>
